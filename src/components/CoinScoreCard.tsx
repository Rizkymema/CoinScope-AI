...
export const CoinScoreCard: React.FC = () => {
  ...
  if (isAiLoading) {
    return (
      <div className="p-6 bg-slate-900/80 backdrop-blur-sm border border-slate-800/50 rounded-2xl space-y-4">
        {/* Show selected coin info even while loading */}
        {selectedCoin && (
  ...
  return (
    <div className="bg-slate-900/80 backdrop-blur-sm border border-slate-800/50 rounded-2xl overflow-hidden">
      {/* Selected Coin Header with Image */}
      <div className="p-6 border-b border-slate-800/50 bg-gradient-to-r from-slate-800/30 to-transparent">
      ...
      <div className="p-6 space-y-5">
        ...
        <div className="flex items-center justify-between">
          ...
          <span className={`text-xs font-bold uppercase tracking-wider px-3 py-1 rounded-full border ${
            ...
            aiAnalysis.category === 'Hold' ? 'bg-blue-500/10 text-blue-400 border-blue-500/30' :
        ...
        {/* Analysis Quote */}
        <div className="p-4 bg-indigo-950/15 border border-indigo-900/20 rounded-xl">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
          {[
            ...
            <div key={i} className="p-3 bg-slate-800/30 rounded-xl border border-slate-800/50">
